...
if(isset($_POST['courseName']) && isset($_POST['courseCode']) && isset($_POST['department']) && isset($_POST['year']) && isset($_POST['semester'])){
    ...
    $query = $mysqli->query("SELECT * FROM course WHERE courseCode='$courseCode' AND departmentName = '$department'");
